...
export default function NodeUpdateForm(props) {
  ...
  const [nodeRecord, setNodeRecord] = React.useState(node);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Node, idProp) : node;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Node.copyOf(nodeRecord, (updated) => {
